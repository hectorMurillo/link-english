...
export const WhatsAppBubble: React.FC = () => {
  ...
  return (
    <aside aria-label="Contacto por WhatsApp" className="fixed bottom-6 right-6 z-50 flex items-end flex-col gap-2">
      ...
      {showTooltip && (
        <div className="hidden sm:flex items-center gap-2 bg-slate-900/95 border border-slate-700/80 text-white text-xs py-2 px-3.5 rounded-2xl shadow-xl backdrop-blur-md animate-bounce-slow">
          <span>¿Dudas sobre los cursos? ¡Escríbenos!</span>
          <button
      ...
      <a
        ...
        aria-label="Chatear con Link English por WhatsApp"
