...
import { Users, Award, BookOpen, Clock, CheckCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              En <strong className="text-white font-semibold">Link English</strong>, rompemos la
              barrera del idioma a través de cursos dinámicos y enfocados directamente en el ámbito
              laboral. Nuestro equipo está compuesto por profesionales dedicados y constantemente
              capacitados para garantizar una experiencia educativa interactiva, sin métodos
              tradicionales aburridos.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                ...
                <span className="text-sm text-slate-200">
                  Práctica conversacional desde la primera sesión
                </span>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-sm text-slate-200">
                  Enfoque laboral directo (presentaciones y emails)
                </span>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-sm text-slate-200">
                  Docentes en constante capacitación metodológica
                </span>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-sm text-slate-200">
                  Acompañamiento cercano y retroalimentación continua
                </span>
              </div>
            </div>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-slate-700 shadow-2xl bg-slate-800">
                <img
                  ...
                  alt="Estudiante Link English aprendiendo activamente"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-slate-900/90 backdrop-blur-md border border-slate-700/80 p-4 rounded-xl flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-lg font-bold text-white leading-none">150+ Alumnos</div>
                      <div className="text-xs text-slate-400 mt-1">Actualmente en formación</div>
                    </div>
                  </div>
